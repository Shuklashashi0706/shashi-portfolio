...
import logo from "../assets/shashi.webp";
    ...
    <Fragment>
      ...
      >
        <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-2">
          ...
          <a
            href="https://www.linkedin.com/in/shashi-kumar-shukla/"
            target="_blank"
            class="button hidden mr-8 text-n-1/50 transition-colors lg:text-n-1 lg:block lg:text-base"
          >
            Hire Me
          </a>
          <Button className={"hidden lg:flex lg:text-base"}>
            <a href="https://buymeacoffee.com/shuklashasi" target="_blank">
            Buy Me a Coffee
            </a>
          </Button>
          <Button
